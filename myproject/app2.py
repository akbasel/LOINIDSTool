...
def get_construction_objects(loin_xml):
    ...
    # Find distinct construction objects in the LOIN XML
    ...
    for construction_object in loin_root.findall(".//ns0:DataTemplate", namespaces=namespace_map):
        ...
        if construction_object_name is not None:
            ...
            print(str(construction_objects), "my")
#             print("construction_objects", ET.tostring(construction_objects, encoding="utf-8").decode("utf-8"))
...
#             target_name = construction_object_name.get("TargetName")
#             construction_objects.add(target_name)
#             print("construction_objects.add(target_name)", construction_objects.add(target_name))
...
def get_property_sets_and_properties(loin_xml):
    ...
    # Find distinct property sets and properties in the LOIN XML
    property_sets = set()
    properties = set()
...
#                     print("  Target UUID of Component:", target_UUID_property
                    properties.add(f"{setofprop_name}:{property_name}")
...
#     
#     for construction_object in loin_root.findall(".//ns0:DataTemplate", namespaces=namespace_map):
#         setofprop_elements = construction_object.findall(".//ns0:SetOfProperties", namespaces=namespace_map)
#         print("setofprop_elements", ET.tostring(setofprop_elements, encoding="utf-8").decode("utf-8"))
#         for setofprop in setofprop_elements:
#             print("setofprop", setofprop)
#             setofprop_name = setofprop.get("TargetName")
#             print("setofprop_name", setofprop_name)
#             property_sets.add(setofprop_name)
# 
#             property_elements = setofprop.findall(".//ns0:Property", namespaces=namespace_map)
#             print("property_elements", property_elements)
#             print("property_elements", ET.tostring(property_elements, encoding="utf-8").decode("utf-8"))
#             for property_element in property_elements:
#                 print("property_element", property_element)
#                 print('hezz')
#                 property_name = property_element.find(".//ns0:Name", namespaces=namespace_map).text
#                 
#                 print("property_name", property_name)
#                 properties.add(f"{setofprop_name}:{property_name}")
#                 print(f"{setofprop_name}:{property_name}")
